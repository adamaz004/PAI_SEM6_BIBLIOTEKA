...
function updateSecondSelect() {
  ...
  if (selectedOption === "name") {
    ...
    // Dodanie opcji Od najwyższej i Od najniższej
    var optionHighest = document.createElement("option");
    optionHighest.value = "highest";
    optionHighest.text = "Od najwyższej";
    secondSelect.appendChild(optionHighest);

    var optionLowest = document.createElement("option");
    optionLowest.value = "lowest";
    optionLowest.text = "Od najniższej";
    secondSelect.appendChild(optionLowest);
  } else if (selectedOption === "status") {
    // Dodanie opcji Dostępne, Zarezerwowane, Wypożyczone
    var optionAvailable = document.createElement("option");
    optionAvailable.value = "available";
    optionAvailable.text = "Dostępne";
    secondSelect.appendChild(optionAvailable);

    var optionReserved = document.createElement("option");
    optionReserved.value = "reserved";
    optionReserved.text = "Zarezerwowane";
    secondSelect.appendChild(optionReserved);

    var optionRented = document.createElement("option");
    optionRented.value = "rented";
    optionRented.text = "Wypożyczone";
    secondSelect.appendChild(optionRented);
  }
}
  </script>
